...
public class FlywayInTestcontainersExtension implements BeforeEachCallback {
    private static final Logger LOG = LoggerFactory.getLogger(FlywayInTestcontainersExtension.class);
    ...
    public void beforeEach(ExtensionContext context) throws Exception {
        ...
        JdbcDatabaseContainer<?> databaseContainer = instance
                ...
                .flatMap(fields -> Arrays.stream(fields)
                        .filter(field -> JdbcDatabaseContainer.class.isAssignableFrom(field.getType()))
                        .findFirst())
        ...
        configuration.dataSource( /*docker here ;)*/
